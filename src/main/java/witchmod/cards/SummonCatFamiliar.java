...
public class SummonCatFamiliar extends AbstractWitchCard {
	...
	public static final	String NAME = "Summon Cat Familiar";
	public static final	String IMG = "cards/placeholder_power.png";
	public static final	String DESCRIPTION = "At the start of your turn, add a Cat Familiar card to your hand. NL Limit 1 Familiar power active.";
	public static final	String DESCRIPTION_UPGRADED = "At the start of your turn, draw an upgraded Cat Familiar card to your hand. NL Limit 1 Familiar power active.";
