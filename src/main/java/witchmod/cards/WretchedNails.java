...
public class WretchedNails extends AbstractWitchCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new WaitAction(1.25f));
    ...
    public void applyPowers() {
        ...
        rawDescription = rawDescription + cardStrings.EXTENDED_DESCRIPTION[0] + damage + cardStrings.EXTENDED_DESCRIPTION[1];
